...
class _$NewInvestmentStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object connectedCardId = freezed,
    ...
    return _then(_value.copyWith(
      ...
      connectedCardId: connectedCardId == freezed
          ? _value.connectedCardId
          : connectedCardId as String,
...
class _$_NewInvestmentState implements _NewInvestmentState {
  ...
  @override
  String toString() {
    return 'NewInvestmentState(investmentProduct: $investmentProduct, amount: $amount, duration: $duration, tenure: $tenure, paystackReference: $paystackReference, connectedCardId: $connectedCardId, investmentDate: $investmentDate, maturityDate: $maturityDate, investmentRate: $investmentRate, accruedInterest: $accruedInterest, withholdingTax: $withholdingTax, maturityValue: $maturityValue, durations: $durations, showErrorMessages: $showErrorMessages, isSubmitting: $isSubmitting, submitFailureOrSuccess: $submitFailureOrSuccess)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _NewInvestmentState &&
            ...
            (identical(other.connectedCardId, connectedCardId) ||
                const DeepCollectionEquality()
                    .equals(other.connectedCardId, connectedCardId)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(connectedCardId) ^
