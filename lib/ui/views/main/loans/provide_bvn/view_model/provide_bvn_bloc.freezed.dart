...
class _$CheckBVN implements CheckBVN {
  ...
  @override
  String toString() {
    return 'ProvideBvnEvent.checkBVN()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is CheckBVN);
  }
...
// ignore: unused_element
  _ProvideBvnState call(
    ...
    return _ProvideBvnState(
      ...
      provideBVNFailureOrSuccess: provideBVNFailureOrSuccess,
      verifyBVNFailureOrSuccess: verifyBVNFailureOrSuccess,
    );
  }
}
...
mixin _$ProvideBvnState {
  ...
  Option<Either<ValueFailure, Unit>> get provideBVNFailureOrSuccess;
  Option<Either<ValueFailure, Unit>> get verifyBVNFailureOrSuccess;
...
abstract class $ProvideBvnStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool isSubmitting,
      Option<Either<ValueFailure, Unit>> provideBVNFailureOrSuccess,
...
class _$ProvideBvnStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object provideBVNFailureOrSuccess = freezed,
    Object verifyBVNFailureOrSuccess = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      provideBVNFailureOrSuccess: provideBVNFailureOrSuccess == freezed
          ? _value.provideBVNFailureOrSuccess
          : provideBVNFailureOrSuccess as Option<Either<ValueFailure, Unit>>,
      verifyBVNFailureOrSuccess: verifyBVNFailureOrSuccess == freezed
          ? _value.verifyBVNFailureOrSuccess
          : verifyBVNFailureOrSuccess as Option<Either<ValueFailure, Unit>>,
    ));
  }
}
...
class _$_ProvideBvnState implements _ProvideBvnState {
  const _$_ProvideBvnState(
      ...
      @required this.provideBVNFailureOrSuccess,
      @required this.verifyBVNFailureOrSuccess})
      : assert(showErrorMessages != null),
        assert(isSubmitting != null),
        assert(provideBVNFailureOrSuccess != null),
        assert(verifyBVNFailureOrSuccess != null);
  ...
  @override
  final Option<Either<ValueFailure, Unit>> provideBVNFailureOrSuccess;
  @override
  final Option<Either<ValueFailure, Unit>> verifyBVNFailureOrSuccess;

  @override
  String toString() {
    return 'ProvideBvnState(showErrorMessages: $showErrorMessages, isSubmitting: $isSubmitting, provideBVNFailureOrSuccess: $provideBVNFailureOrSuccess, verifyBVNFailureOrSuccess: $verifyBVNFailureOrSuccess)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ProvideBvnState &&
            ...
            (identical(other.provideBVNFailureOrSuccess,
                    provideBVNFailureOrSuccess) ||
                const DeepCollectionEquality().equals(
                    other.provideBVNFailureOrSuccess,
                    provideBVNFailureOrSuccess)) &&
            (identical(other.verifyBVNFailureOrSuccess,
                    verifyBVNFailureOrSuccess) ||
                const DeepCollectionEquality().equals(
                    other.verifyBVNFailureOrSuccess,
                    verifyBVNFailureOrSuccess)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(provideBVNFailureOrSuccess) ^
      const DeepCollectionEquality().hash(verifyBVNFailureOrSuccess);
