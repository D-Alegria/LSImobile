...
_$_OperatingExpenses _$_$_OperatingExpensesFromJson(Map<String, dynamic> json) {
  return _$_OperatingExpenses(
...
Map<String, dynamic> _$_$_OperatingExpensesToJson(
        _$_OperatingExpenses instance) =>
    <String, dynamic>{
