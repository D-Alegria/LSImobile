...
_$_BusinessIncome _$_$_BusinessIncomeFromJson(Map<String, dynamic> json) {
  return _$_BusinessIncome(
...
Map<String, dynamic> _$_$_BusinessIncomeToJson(_$_BusinessIncome instance) =>
    <String, dynamic>{
